...
//owner v card
global.vcardowner = ['+212710076108'] // owner number
global.ownername = "Twins ym" // owner name
global.ytname = "" // Twins Ym
global.socialm = "www.instagram.com/elpotlood" // instagram
global.location = "Morroco, Amizmiz, Aizawl" // location

//bot body 
global.alivepic = `https://ibb.co/Gxz7Ldy` // alive picture \\ use "https://ibb.com" to upload photos. < 1 MB
...
global.owner = ['+212710076108']
global.ownertag = '+212710076108' //your tag number
global.botname = 'Twins ym' //ur bot name
global.packname = "Twins ym Stc" // sticker packname
global.author = "Twins ym" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ Twins ym ]' //

//database
global.premium = ['+212710076108'] //ur premium numbers
...
global.mess = {
    success: 'TWINS YM',
    admin: ' الأدمين لي قدر يبوسطي !😉',
    botAdmin: 'بغيت نولي أدمين😥',
    owner: 'غير الأونر ليقدر يخدم هادشي!😉',
    group: 'هاد التقاشر كيخدمو غير فالغروب!',
    private: 'هاد التويشية كاينة غير فالبريفي!',
    bot: 'هاد اللعيبة كتخد غير من لبوت لبوت الراس فالراس😝',
    wait: '👉👈بغيتها أمبورطي ولا تديها معاك ههههه...',
    error: 'Error!!! فين غادي فين اوا غادي 🤔!',
    endLimit: 'عييتيني أخويا راه غير بوت أنا تسنا غير 12 ساعة',
    linkm: 'فين هو ليان اشريف(ة)?',
    nsfw: 'The nsfw مخداماش عندك',
    banChat: 'تهنيتي هانتا بانيتيني ...سير قول لمول البوت يأكتيفي هاد اللهج',
    badwords: '*🚫السبان لا  اصاحبي راه حرام 🥺 !*\n\n⚠️ Warning... ⚠️',
    spam: '⚠️ [SPAM] حصلتي⚠️\n\nThe emergency security system was activated.\n\nPowered By: *Twins ym*',
    caption: 'Generated by: ◉ *Twins ym*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
